...
('hart',0.7, 0.5, 0.08, (5,20,40)::fT_t, 0.01, (1,0,47.5,3.5)::tdp_t, .26, (19,10.8,5,2)::tdp_t, (0.0001,0.02, 2.6)::cond_t, (0,0.24,7.3)::intcpt_t, (0.17,0.7,0.5,0.02)::pR_t, 0.47, (2.8, 0.18, 2.4, 2, -1.161976, 1.91698)::pfs_t, (0.2,10,0.75)::rootP_t, (0.0015,0.03,2,2.5)::tdp_t, 0.5),
('hart-stick',1.5, 0.5, 0.08, (5,20,40)::fT_t, 0.05,(1,0,47.5,3.5)::tdp_t, 0.26, (19,10,5,2)::tdp_t, (0.0001,0.02, 2.6)::cond_t, (0,0.24,7.3)::intcpt_t, (0.17,0.7,.5,0.02)::pR_t, 0.47, (1, 0.18, 2.4, 2, -1.161976, 1.91698)::pfs_t, (0.01, 10, 0.6)::rootP_t, (0.0015,0.03,2,2.5)::tdp_t, 0.5),
...
from tree t, tree t2,(VALUES ('amichev'),('headlee2012'),('hart')) as u(n)
